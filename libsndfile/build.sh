...
AGS_DEPENDENCY=()
AGS_TARBALL="libsndfile-1.0.31.tar.bz2"
AGS_MD5="3f3b2a86a032f064ef922a2c8c191f7b"
...
# unpack
tar -xxf libsndfile-1.0.31.tar.bz2
cd libsndfile-1.0.31

# build
./configure --prefix="${ags_prefix}"    \
            --disable-static \
            --docdir="${ags_prefix}"/share/doc/libsndfile-1.0.31
make
